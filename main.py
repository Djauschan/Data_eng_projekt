...
def all_plots():
    ...
    #alle Plots returnen
    return unpopular_week_plot,unpopular_week_overall_plot,unpopular_weekday,eight_wake_up_plot,wanted_cluster,unwanted_cluster,heatmap_plot,liked_plot,liked_plot_overall